...
class HomeActivity() : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val itemAdapter = ArrayAdapter(
            this,
            android.R.layout.simple_spinner_item,
            Arrays.asList("3 items", "4 items", "5 items")
        )
        ...
        when (itemSpinner.selectedItemPosition) {
            0 -> {
                bottomNavigationBar
                    ...
                    .addItem(
                        BottomNavigationItem(
                            R.drawable.ic_find_replace_white_24dp,
                            "Find"
                    ...
                    .addItem(
                        BottomNavigationItem(
                            ...
                            "Categories"
                        ).setActiveColorResource(R.color.blue).setBadgeItem(shapeBadgeItem)
                    )
                    .initialise()
                bottomNavigationBar.selectTab(
                    if (lastSelectedPosition > 2) 2 else lastSelectedPosition,
                    true
                )
            }
            ...
            1 -> {
                bottomNavigationBar
                    ...
                    .initialise()
                bottomNavigationBar.selectTab(
                    if (lastSelectedPosition > 3) 3 else lastSelectedPosition,
                    true
                )
            }
